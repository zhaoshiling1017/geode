...
public class ServerHandshakeImpl extends Handshake implements ServerHandshake {
  /**
  ...
  public ServerHandshakeImpl(ClientProxyMembershipID proxyId,
   ...
   */
  public ServerHandshakeImpl(ServerHandshakeImpl handShake) {
    super(handShake);
